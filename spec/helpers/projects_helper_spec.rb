...
RSpec.describe ProjectsHelper, type: :helper do
  ...
  describe "project_dates" do
    ...
    context "when the start date and end date are the same" do
      before do
        FactoryBot.create(:default_project_slot, slot_date: '01/01/2018', project: project)
      end
    ...
    context "when the start date and end date are different but in the same month" do
      before do
        FactoryBot.create(:default_project_slot, slot_date: '02/02/2018', project: project)
        FactoryBot.create(:default_project_slot, slot_date: '03/02/2018', project: project)
      end
